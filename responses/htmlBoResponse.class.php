...
//	public $canAdmin = ($_SESSION['JELIX_USER']->profilId != 1)? 0 : 1;
	...
	const MENU_OFFICIEL = 11;
	const MENU_OFFICIEL_LISTE = 0;

	const MENU_BANNIERE = 12;
	const MENU_BANNIERE_LISTE = 0;

	const MENU_PARAMETRE = 13;
	...
	const MENU_PARAMETRE_CAT_OFFICIEL = 4;
	const MENU_PARAMETRE_MARQUE = 5;
	const MENU_PARAMETRE_MODELE = 6;
