<?php 
 require_once('C:\Program Files (x86)\EasyPHP-5.3.8.1\www\projects\jelix\ilay-nosy\lib\jelix/plugins/tpl/text/function.jurl.php');
...
function template_meta_a11ad01a1613e5a51ecd87e684f11ccd($t){

return $t->_meta;
}
function template_a11ad01a1613e5a51ecd87e684f11ccd($t){
?><div class="sortableListWithPagination">
<table class="expanded" cellspacing="0"  id="tableListeAnnonce" currentSortField="<?php echo $t->_vars['sortField']; ?>" currentSortDirection="<?php echo $t->_vars['sortDirection']; ?>" currentPage="<?php echo $t->_vars['page']; ?>" nbPage="<?php echo $t->_vars['nbPage']; ?>" src="<?php jtpl_function_text_jurl( $t,'commun~communBo_getZone', $t->_vars['tParams']);?>">
	<thead>
		<tr>
			<?php $t->_vars['i']=0;?>
			...
			<?php foreach($t->_vars['toAnnonce'] as $t->_vars['oAnnonce']):?>
                ...
                <tr class="row<?php echo $t->_vars['i']++%2+1; ?>"> 
                    ...
                    <td width="10%" class="color2 _center">
                        <a href="<?php jtpl_function_text_jurl( $t,'annonce~annonceBo_editionAnnonce', $t->_vars['tPost']);?>" class="blueHead">
                    ...
                    <td width="30%" class="color2 _center">
                        <a href="<?php jtpl_function_text_jurl( $t,'annonce~annonceBo_editionAnnonce', $t->_vars['tPost']);?>"><?php echo $t->_vars['oAnnonce']->annonce_titre; ?></a>
                    ...
                    <td width="10%" style="text-align:center" class="color1"><a href="<?php jtpl_function_text_jurl( $t,'annonce~annonceBo_editionAnnonce', $t->_vars['tPost']);?>"><img src="<?php echo $t->_vars['j_basepath']; ?>design/back/images/edit.gif" /></a></td>
                    <td width="10%" class="color2" style="text-align:center">
                        ...
                        <?php else:?>
                            <a id="btn_supprimer" alt="supprimer" href="<?php jtpl_function_text_jurl( $t,'annonce~annonceBo_supprimeAnnonce', $t->_vars['tPost']);?>"><img src="<?php echo $t->_vars['j_basepath']; ?>design/back/images/delete.gif"/></a>
                        <?php endif;?>
                    </td>			
