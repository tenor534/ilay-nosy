<?php 
function template_meta_8841d18eb4b24ffc3fcc861e11ec61bc($t){

return $t->_meta;
}
function template_8841d18eb4b24ffc3fcc861e11ec61bc($t){
				...
				<div id="main" class="fullWhite">
                    ...
                    <div id="brown">
						...
						<div id="adRightFo">
                            ...
                            <?php echo $t->_vars['innerPageAdContacts']; ?>
