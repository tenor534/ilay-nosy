...
function template_meta_0fd064541e80e06ae94fc7bd681fc9c5($t){

return $t->_meta;
}
function template_0fd064541e80e06ae94fc7bd681fc9c5($t){
?><div class="sortableListWithPagination">
<table class="expanded" cellspacing="0"  id="tableListeModele" currentSortField="<?php echo $t->_vars['sortField']; ?>" currentSortDirection="<?php echo $t->_vars['sortDirection']; ?>" currentPage="<?php echo $t->_vars['page']; ?>" nbPage="<?php echo $t->_vars['nbPage']; ?>" src="<?php jtpl_function_text_jurl( $t,'commun~communBo_getZone', $t->_vars['tParams']);?>">
	<thead>
		<tr>
			<?php $t->_vars['i']=0;?>
	...
	<tbody>
		...
		<?php else:?>
			...
			<tr class="row<?php echo $t->_vars['i']++%2+1; ?>"> 
				...
				<td width="5%" style="text-align:center" class="color1"><a href="<?php jtpl_function_text_jurl( $t,'modele~modeleBo_editionModele', array('modele_id'=>$t->_vars['oModele']->modele_id, 'page'=>$t->_vars['page']));?>"><img src="<?php echo $t->_vars['j_basepath']; ?>design/back/images/edit.gif" /></a></td>
				<td width="5%" class="color2" style="text-align:center">
					...
					<?php else:?>
						<a id="btn_supprimer" alt="supprimer" href="<?php jtpl_function_text_jurl( $t,'modele~modeleBo_supprimeModele', $t->_vars['tPost']);?>"><img src="<?php echo $t->_vars['j_basepath']; ?>design/back/images/delete.gif"/></a>
					<?php endif;?>
				</td>			
