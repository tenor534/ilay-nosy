...
function template_meta_d3b95c94bdeecbb919c1b02aa6654856($t){

return $t->_meta;
}
function template_d3b95c94bdeecbb919c1b02aa6654856($t){
									...
									<form id="loginForm" name="loginForm" method="POST" tmt:validate="true" tmt:callback="displayError">
                                        ...
                                        <div class="loginContent">
                                            ...
                                            <p>
	                                        	...
	                                        	<br>
    	                                        <a href="<?php jtpl_function_html_jurl( $t,'commun~communFo_register');?>" class="formButton_register">valid</a>
	                                        	<br>
	                                        	<br>
                                            </p>    
                                        </div>
