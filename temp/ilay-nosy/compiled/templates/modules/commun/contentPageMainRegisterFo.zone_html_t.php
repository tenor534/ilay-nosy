...
function template_meta_74abfc0b358cd1bb91ba4f5571f3a396($t){

return $t->_meta;
}
function template_74abfc0b358cd1bb91ba4f5571f3a396($t){
									...
									<form id="registerForm" name="registerForm" method="POST" tmt:validate="true" tmt:callback="displayError" enctype="multipart/form-data">
                                        ...
                                        <div class="registerContent">                                        
                                            ...
                                            <?php for($t->_vars['i']=0; $t->_vars['i']<sizeof($t->_vars['toPays']);$t->_vars['i']++):?>  
	                                            ...
	                                            <option value="<?php echo $t->_vars['toPays'][$t->_vars['i']]->pays_id; ?>" <?php if($t->_vars['toPays'][$t->_vars['i']]->pays_id == '128'):?>selected<?php endif;?>><?php echo $t->_vars['toPays'][$t->_vars['i']]->pays_libelle; ?></option>
                                            <?php endfor;?>
                                            </select><br>
                                        ...
                                        <div class="registerContent">
                                            ...
                                            <a href="<?php jtpl_function_html_jurl( $t,'commun~communFo_login');?>" class="formButton_login">valid</a>
