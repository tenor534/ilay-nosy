...
jQuery(document).ready(function() {
	...
	$(".formButton_valid").click(function(){
		...
		if (!tmt_validateForm(document.registerForm)) {
			...
			user_civilite 	=$('[@name=user_civilite] option:selected').text();
			user_nom 		= $('[@name=user_nom]').val();
			user_prenom 	= $('[@name=user_prenom]').val();
			user_societe 	= $('[@name=user_societe]').val();
			user_pays 		= $('[@name=user_pays] option:selected').text();
			user_cp 		= $('[@name=user_cp]').val();
			...
			$.ajax({
				 ...
				 success:function(resultat){
					...
					html += '<p>';
					html += 'Nous vous invitons &agrave; consulter la page d\'accueil en cliquant <a href="index.htm">ici</a>.<br>';
					html += '</p>';
					html += '<p>&nbsp;</p>';
					html += '<p>';
					...
					html += '	<a href="mailto:contact@dword-consulting.com">contact@dword-consulting.com</a><br>';
