...
/* cible: selection catégorie */
function selectCategorieAn(obj){
	var cid = $(obj).val();
	zUrl = j_basepath + 'index.php?cid='+cid+'&module=petiteAnnonce&action=petiteAnnonceFo_petiteAnnonceList';			
		...
		if (!tmt_validateForm(document.annonceForm)) {
			...
			var options = {
				 ...
				 success: function(msg) {
					...
					var cid	= $('#petiteAnnonce_categorieAnId').val();	
					
					alert("Votre annonce s'affichera après modération. Merci de votre confiance");				
					document.location.href="index.php?cid=" + cid + "&module=petiteAnnonce&action=petiteAnnonceFo_petiteAnnonceList";						
				}
			};
