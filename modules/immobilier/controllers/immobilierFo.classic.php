...
class utilisateurFoCtrl extends jController {
	...
	/**
    * Supprime la immobilier de profil d'un membre utilisateur
	* 
    ...
    */
    function removeImmobilier() {
		...
		//Nom du fichier
		$zNomFichier = $utilisateur->profilImmobilier;
		...
		//Paramètres
		$response['imgSrc'] = "noimmobilier.jpg";
	...
	/**
    * Changement de la immobilier de profil d'un membre utilisateur
	* 
	* Utilisé via mode edition popup 
	* Recoit en paramètre l'ensemble des données du formulaire d'édition d'un membre
	* Une fois ls utilisateur sauvegardée, redirige vers la page de liste des membres
    */
    function changeImmobilier() {
		//Préparation de la réponse
		global $gJConfig;
		...
		//upload du fichier
		$zNomFichier 		= tools::uploadFile ("user_immobilier", $zPathMedia) ;
		$utilisateur->immobilier = $zNomFichier;
		...
		if($zNomFichier){
			...
			//resize fichier au format immobilier : 180 x 135
			//tools::resizeImage($zPathMedia.''.$zNomFichier, $zPathResize.'immobilier/'.$zNomFichier, ANNONCE_PHOTO_WIDTH, ANNONCE_PHOTO_HEIGHT, 'ratio');
			tools::resizeImage2($zPathMedia.''.$zNomFichier, $zPathResize.'immobilier/'.$zNomFichier, $zPathResize.'immobilier/blank.jpg', ANNONCE_PHOTO_WIDTH, ANNONCE_PHOTO_HEIGHT, $im_color, $im_cropratio, $im_quality);
