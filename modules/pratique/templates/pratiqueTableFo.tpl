                	...
                	<div id="white">      
                       ...
                       <div id="middleContent">
                            <div class="row" id="mainNews">
	                            <div class="header">
                                	<h3>Pratiques et services</h3>
                                </div><!-- header:[end] -->
                                <div class="singleColumnBig">

                                    <!--Pannel pour navigation en espace Pratique-->
                                    {*}
                                    <div id="memberWrap" class="{$zMemberWrap}">
                                        <div id="memberNavWrap">
                                             <ul class="memberNav memberNav-example-animate current-about">
                                                 ...
                                                 <li class="member_pratique"><a href="{jurl 'pratique~pratiqueFo_pratiqueList'}" title="Vos pratiques">Vos pratiques</a></li>
