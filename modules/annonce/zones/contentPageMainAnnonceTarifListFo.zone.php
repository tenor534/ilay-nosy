...
* @subpackage membre
*/
class contentPageMainAnnonceTarifListFoZone extends jZone {
 
	/**
	* Nom du template HTML
	*/
    protected $_tplname='annonce~contentPageMainAnnonceTarifListFo.zone';
	...
	*/
	protected function _prepareTpl(){
		...
		$tParams = array('zone'=> $this->getParam('zone','annonce~contentPageMainAnnonceTarifListFo'));
