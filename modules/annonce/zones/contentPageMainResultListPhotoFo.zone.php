...
* @subpackage membre
*/
class contentPageMainResultListPhotoFoZone extends jZone {
	  
 
	/**
	* Nom du template HTML
	*/
    protected $_tplname='annonce~contentPageMainResultListPhotoFo.zone';
	...
	*/
	protected function _prepareTpl(){
		...
		$tParams = array('zone'=> $this->getParam('zone','annonce~contentPageMainResultListPhotoFo'), 'nbPagination'=> $this->nbPagination, 'affichage'=> $this->affichage, 'cid'=> $this->cid, 'rid'=> $this->rid, 'mot'=> $this->mot, 'crid'=> $this->crid, 'parution'=> $this->parution, 'province'=> $this->province, 'localite'=> $this->localite, 'prix1'=> $this->prix1, 'prix2'=> $this->prix2);
