...
* @subpackage membre
*/
class contentPageMainAbonnementForfaitListFoZone extends jZone {
 
    protected $_tplname='abonnement~contentPageMainAbonnementForfaitListFo.zone';
	...
	*/
	protected function _prepareTpl(){
		...
		//Edite des abonnement avec le type de forfait à selectionner		
