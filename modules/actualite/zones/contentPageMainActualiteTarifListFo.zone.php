...
* @subpackage membre
*/
class contentPageMainActualiteTarifListFoZone extends jZone {
 
	/**
	* Nom du template HTML
	*/
    protected $_tplname='actualite~contentPageMainActualiteTarifListFo.zone';
	...
	*/
	protected function _prepareTpl(){
		...
		$tParams = array('zone'=> $this->getParam('zone','actualite~contentPageMainActualiteTarifListFo'));
