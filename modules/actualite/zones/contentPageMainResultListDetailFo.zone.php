...
class contentPageMainResultListDetailFoZone extends jZone {
	...
	*/
    protected $_tplname='actualite~contentPageMainResultListDetailFo.zone';
	...
	*/
	protected function _prepareTpl(){
		...
		$tParams = array('zone'=> $this->getParam('zone','actualite~contentPageMainResultListDetailFo'), 'nbPagination'=> $this->nbPagination, 'affichage'=> $this->affichage, 'cid'=> $this->cid, 'mot'=> $this->mot, 'parution'=> $this->parution);
