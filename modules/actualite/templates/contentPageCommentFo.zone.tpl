                                    ...
                                    <table class="commTopic">
                                        ...
                                        <tr>
                                            ...
                                            <a name="{$oCommentaires->commentAct_id}"></a>
                                                <table>
                                                    <tbody><tr>
                                                        <td class="threadAvatar">
                                                        
                                                        <a href="#">
                                                        <img width="80" height="60" border="0" alt="{$oCommentaires->commentAct_userLogin}" src="{$j_basepath}resize/utilisateur/images/abrege/{$oCommentaires->commentAct_userPhoto}" name="{$oCommentaires->commentAct_id}">
                                                        </a>
                                                        
                                                        </td>
                                                        <td class="avatarRightWrap">
                                                            <p class="avatarRightFirst"><a href="#" class="crumbsBlue avatarRight">{$oCommentaires->commentAct_userLogin}</a></p>
                                                            {if $oCommentaires->commentAct_userNbPost > 0}
	                                                            <p class="regTextPale avatarRight">{$oCommentaires->commentAct_userNbPost} message{if $oCommentaires->commentAct_userNbPost > 1}s{/if}</p>
                                                            {/if}
                                                            <p class="commMember avatarRight">Membre depuis  {$oCommentaires->commentAct_userDateCreation|date_format:"%d/%m/%Y"}</p>
                                            ...
                                            <td class="threadBody2">
                                                ...
                                                <p>{$oCommentaires->commentAct_texte}</p>
                                                
                                                <ul>
                                                    <p class="regTextPaleNormal borderNoneInline">Publié le: {$oCommentaires->commentAct_dateCreation|date_format:"%d/%m/%Y (%H:%M:%S)"}</p>
