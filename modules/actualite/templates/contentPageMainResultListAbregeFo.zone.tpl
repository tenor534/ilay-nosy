                                                ...
                                                {else}
                                                    ...
                                                    <tr>
                                                        <td class="annonceBody0">
                                                            <a href="{jurl 'actualite~actualiteFo_actualiteDetail', $tPost}" class="blueHead">
                                                        ...
                                                        <td class="annonceBody1">
                                                            <h5>{$oActualite->categorieAct_libelle}</h5>
                                                        </td>
                                                        <td class="annonceBody1">
                                                            <h5><a class="titre" href="{jurl 'actualite~actualiteFo_actualiteDetail', $tPost}">{$oActualite->actualite_titre}</a></h5>
                                                            <ul class="split">
                                                                <li class="last">R&eacute;f. <a>{$oActualite->actualite_reference}</a></li>
                                                            </ul>                                                            
                                                            <p>
                                                                <span class="parution">Source : <a>{$oActualite->actualite_source}</a></span>
                                                            </p>
                                                            <p>
                                                                <span class="parution">Vue : <a>{$oActualite->actualite_visite}</a></span>
                                                            </p>
                                                            <p>
                                                                <span class="parution">Commentaire : <a>{$oActualite->actualite_nbComment}</a></span>
                                                            </p>
                                                        </td>
                                                        {*}
                                                        <td class="annonceBody2">
                                                            <h5><span class="nowrap">{$oActualite->actualite_resume}</span><span class="supp_info"></span></h5>
                                                        </td>
                                                        {*}
                                                        <td class="annonceBody5">
                                                            <p><span class="parution">{$oActualite->actualite_datePublication}</span></p>
                                                        </td>                                                
                                                    </tr>    
                                                    {assign $j++}
                                                    {/foreach}
