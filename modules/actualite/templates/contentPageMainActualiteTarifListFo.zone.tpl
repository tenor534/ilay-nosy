                                    ...
                                    {foreach $toPacks as $oPacks}
                                                ...
                                                <div class="result_desc">
                                                    ...
                                                    <div class="desc_txt">
                                                        ...
                                                        {else}
                                                            {*}PACK_VISITEURS{*}
                                                            <h5>Caract&eacute;ristiques</h5>
                                                            <p>Profitez de cette offre pour consulter toutes les actualites du site avec possibilit&eacute; de voir les contacts ou les coordonn&eacute;es des actualiteurs. </p>
                                                        {/if}
                                        ...
                                        {elseif $iType == 2}
                                            ...
                                            <div class="{$zUseCss}" id="box_passepartout">
                                                ...
                                                <div class="bloc_desc">
                                                    <br><span class="separateur">&nbsp;</span> toutes les actualites <span class="separateur">&nbsp;</span> contacts des actualiteurs <br>
                                                    <span class="separateur">&nbsp;</span> coordonn&eacute;es de actualiteurs
                                                    <br>
                                            
                                                    <br><span class="separateur">&nbsp;</span> toutes les actualites <span class="separateur">&nbsp;</span> contacts des actualiteurs <br>
                                                    <span class="separateur">&nbsp;</span> coordonn&eacute;es de actualiteurs<br>
                                                    <span class="separateur">&nbsp;</span> Alerts actualites
                                                </div>
                                                <div class="bloc_prix">
                                                    {assign $t=sizeof($toForfaits)} 
                                                    {assign $i=1}                                                  
                                        ...
                                        {else}   
                                            ...
                                            <div id="box_autres_paiment" class="{$zUseCss}">
                                                ...
                                                <div class="bloc_desc">
                                                    <p>
                                                    2 actualites ( 5 photos - 3 mois de parution)<br>
                                                    2 actualites &agrave; valeur ajout&eacute;e (9 photos)
                                                    </p>
                                                    <p>
                                                    5 actualites ( 5 photos - 3 mois de parution)<br>
                                                    5 actualites &agrave; valeur ajout&eacute;e (9 photos)
                                                    </p>
                                                    <p>
                                                    25 actualites ( 5 photos - 3 mois de parution)<br>
                                                    25 actualites &agrave; valeur ajout&eacute;e (10 photos)
                                                    </p>
                                                    <p>
                                                    50 actualites ( 5 photos - 3 mois de parution)<br>
                                                    50 actualites &agrave; valeur ajout&eacute;e (10 photos)
                                                    </p>
                                                    <p>
                                                    10 actualites 5 photos - 3 mois de parution)
                                                    </p>
                                                </div>
                                                <div class="bloc_prix">
                                                    {assign $t=sizeof($toForfaits)} 
