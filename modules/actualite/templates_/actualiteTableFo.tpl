			...
			<div id="neapolitan">
				...
				<div id="main" class="fullWhite">
                       ...
                       <div id="middleContent">
                            <div class="row" id="mainNews">
                                ...
                                <div class="singleColumnBig">
                                    ...
                                    <!--Pannel pour navigation en espace Actualite-->
                                    {*}
                                    <div id="memberWrap" class="{$zMemberWrap}">
                                        <div id="memberNavWrap">
                                             <ul class="memberNav memberNav-example-animate current-about">
                                                 ...
                                                 <li class="member_actualite"><a href="{jurl 'actualite~actualiteFo_actualiteList'}" title="Vos actualites">Vos actualites</a></li>
                    ...
                    <div id="brown">
                    	{*$innerPageAdSpace*}            
						<div id="adRight">
                           	{$innerPageActualiteVehicule}
                           	{$innerPageActualiteImmobilier}
                           	{$innerPageActualiteEmploi}
                           	{$innerPageActualiteAutres}
                            {*$innerPagePratique*}                                
                        </div><!--adRight: [end]-->                            
                    	{*$innerPageAdSpaces*}
                    </div><!--end brown -->   
