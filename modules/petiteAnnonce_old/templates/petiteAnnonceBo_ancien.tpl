	...
	<div class="ajaxZone">
		<form enctype="multipart/form-data" id='petiteAnnonceForm' name='petiteAnnonceForm' action="{jurl 'petiteAnnonce~petiteAnnonceBo_sauvegardePetiteAnnonce', array('page'=>$page)}" method="POST" tmt:validate="true" tmt:callback="displayError">
		  ...
		  <p class="clearfix">
			<label>Contact: </label>
			<span class="champ">
				<input class="user_input3" type="text" id="petiteAnnonce_contact" name="petiteAnnonce_contact" value="{$petiteAnnonce->petiteAnnonce_contact}" tmt:pattern="phone" tmt:filters="" maxlength="50">                                                        
          	</span>
		  </p>
