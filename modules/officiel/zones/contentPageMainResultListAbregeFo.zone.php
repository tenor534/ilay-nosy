...
class contentPageMainResultListAbregeFoZone extends jZone {
	...
	*/
    protected $_tplname='officiel~contentPageMainResultListAbregeFo.zone';
	...
	*/
	protected function _prepareTpl(){
		...
		$tParams = array('zone'=> $this->getParam('zone','officiel~contentPageMainResultListAbregeFo'), 'nbPagination'=> $this->nbPagination, 'affichage'=> $this->affichage, 'cid'=> $this->cid, 'mot'=> $this->mot, 'parution'=> $this->parution);
