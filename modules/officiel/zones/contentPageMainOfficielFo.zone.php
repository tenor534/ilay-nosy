...
* @subpackage membre
*/	  
class contentPageMainOfficielFoZone extends jZone {
	  
 
	/**
	* Nom du template HTML
	*/
    public $_tplname='officiel~contentPageMainOfficielFo.zone';
	...
	*/
	protected function _prepareTpl(){
		...
		//Template à utiliser
		if ($this->getParam('tplStatic')) {
			$this->tplStatic = $this->getParam('tplStatic');
		}

		$this->_tplname='officiel~staticOfficiel'.$this->tplStatic.'Fo.zone';
		...
		if ($this->getParam('offName')) {
			$this->offName = $this->getParam('offName');
		}else{
			$this->offName = "";
		}	
		...
		$this->_tpl->assign('offName', $this->offName);		
