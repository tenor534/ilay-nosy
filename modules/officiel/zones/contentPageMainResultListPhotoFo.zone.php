...
class contentPageMainResultListPhotoFoZone extends jZone {
	...
	*/
    protected $_tplname='officiel~contentPageMainResultListPhotoFo.zone';
	...
	*/
	protected function _prepareTpl(){
		...
		$tParams = array('zone'=> $this->getParam('zone','officiel~contentPageMainResultListPhotoFo'), 'nbPagination'=> $this->nbPagination, 'affichage'=> $this->affichage, 'cid'=> $this->cid, 'mot'=> $this->mot, 'parution'=> $this->parution);
