			...
			<div id="neapolitan">
				...
				<div id="main" class="fullWhite">
                                    ...
                                    <div id="memberWrap" class="{$zMemberWrap}">
                                        <div id="memberNavWrap">
                                             <ul class="memberNav memberNav-example-animate current-about">
                                                 ...
                                                 <li class="member_officiel"><a href="{jurl 'officiel~officielFo_officielList'}" title="Vos officiels">Vos officiels</a></li>
                    ...
                    <div id="brown">
						...
						<div id="adRightFo">
                           	{$innerPageOfficielVehicule}
                           	{$innerPageOfficielImmobilier}
                           	{$innerPageOfficielEmploi}
                           	{$innerPageOfficielAutres}
                            {*$innerPagePratique*}                                
                        </div><!--adRightFo: [end]-->                            
                    	{*$innerPageAdSpaces*}
                    </div><!--end brown -->   
