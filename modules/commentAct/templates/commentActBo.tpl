...
{else}	  
	...
	<div class="ajaxZone">
		<form enctype="multipart/form-data" id='utilisateurForm' name='utilisateurForm' action="{jurl 'utilisateur~utilisateurBo_sauvegardeUtilisateur', array('page'=>$page)}" method="POST" tmt:validate="true" tmt:callback="displayError">
		  ...
		  <p class="clearfix">
			<label>CommentAct : </label>
			<span class="champ">
				<img id="profile_pic" name="profile_pic" src="{$j_basepath}resize/utilisateur/images/detail/{if $utilisateur->utilisateur_commentAct != ""}{$utilisateur->utilisateur_commentAct}{else}nocommentAct.jpg{/if}" alt="{$utilisateur->utilisateur_prenom} {$utilisateur->utilisateur_nom}">	    
			</span>
		  </p>
		  <p class="clearfix">
			<label>Profile : *</label>
