                                ...
                                <div id="innerpageAnnounce">
                                    ...
                                    <div class="braftonFoot">
                                        ...
                                        <a rel="nofollow" title="Ajouter une petite annonce gratuitement" href="{jurl 'petiteAnnonce~petiteAnnonceFo_petiteAnnonceEdit', array('cid'=> 0)}">Ajouter une petite annonce gratuitement</a>
                                    </div><!-- braftonFoot:[end]-->		
                                    {/if}    
                                    <div class="braftonFoot">
                                        <img src="{$j_basepath}design/front/images/v5/arrowMore.gif" style="display: inline;"/>
