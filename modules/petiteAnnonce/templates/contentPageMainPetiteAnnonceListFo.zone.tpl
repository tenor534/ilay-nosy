                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="annonceBody1">
                                                            ...
                                                            <span class="announceDescription">
                                                                ...
                                                                <h5 style="color:#023755; margin-top:5px;"><span class="nowrap">Prix:&nbsp;{if $oPetiteAnnonce->petiteAnnonce_prix}{$oPetiteAnnonce->petiteAnnonce_prix|format_number: 0, ",", ' ','Ar'}{else}N/D{/if}</span><span class="supp_info">{$oPetiteAnnonce->petiteAnnonce_prixInfo}</span></h5>
                                                                <span style="color:#000">Contact:&nbsp;{$oPetiteAnnonce->petiteAnnonce_contact}</span>
                                                            </span>
                                                        </td>
                                                        {*}
