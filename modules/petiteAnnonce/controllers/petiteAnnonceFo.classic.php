...
class petiteAnnonceFoCtrl extends jController {
    ...
    */
	...
	public $pluginParams = array('updatePetiteAnnonce'=>array('connexion.membre'=>true),
								 ...
								 'petiteAnnonceEdit'=>array('connexion.membre'=>false),
								 'sauvegardePetiteAnnonce'=>array('connexion.membre'=>false),
	...
	function petiteAnnonceEdit()
	{
		...
		$zUrl = jUrl::get('petiteAnnonce~petiteAnnonceFo_petiteAnnonceList', array('cid'=>$this->cid));
		
		$rep->body->assignZone('breadcrumbs', 'commun~breadcrumbsFo', array('zAriane'=>'<a href="'.$zUrl.'">Petites annonces</a><span>&nbsp;&raquo;&nbsp;</span>Edition d\'une annonce'));		
		...
		*/	
		...
		//Caracteristiques
		if(strlen($strCategorie)){
			$rep->body->assignZone('contentPageMainCaracteristique', $strCategorie, array('cid'=>$this->cid));			
			$caracteristique = $rep->body->_vars['contentPageMainCaracteristique'];
		}else{
			$caracteristique = "";
		}	
				
		$rep->body->assignZone('contentPageMain', 'petiteAnnonce~contentPageMainPetiteAnnonceEditFo', array('sortField'=>$this->sortField, 'sortDirection'=>$this->sortDirection, 'page'=>$this->page, 'cid'=>$this->cid, "caracteristique"=>$caracteristique));	
    ...
    */
    function sauvegardePetiteAnnonce() {
		...
		//Save		
		$petiteAnnonce->affichage 			= $this->param('petiteAnnonce_affichage', 0, true);
