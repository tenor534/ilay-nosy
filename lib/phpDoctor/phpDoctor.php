...
require('doc.php');
require('rootDoc.php');
require('packageDoc.php');
require('programElementDoc.php');
require('fieldDoc.php');
require('classDoc.php');
require('executableDoc.php');
require('constructorDoc.php');
require('methodDoc.php');
require('type.php');
require('tag.php');
...
class PHPDoctor
{
	 ...
	 */
	function phpDoctor($options = array())
    {
	 ...
	 * class (e.g. paramtag.php), if it still has not found a tag class
