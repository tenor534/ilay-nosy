...
class captcha {
	...
	public function getImage() {
		...
		*/
		...
		global $gJConfig ;
		if ($this->type == "gif" || $this->type == "GIF")
			imagegif ($im, JELIX_APP_PATH ."www/design/front/captcha/temp") ;

		if ($this->type == "jpeg" || $this->type == "JPEG"){
			imagejpeg ($im, JELIX_APP_PATH ."www/design/front/captcha/temp/" . $this->getRandString() . ".jpg") ;
		}

		if ($this->type == "png" || $this->type == "PNG")
			imagepng ($im, JELIX_APP_PATH."www/design/front/captcha/temp/" . $this->getRandString() . ".gif") ;
