...
require_once(LIB_PATH.'pear/Spreadsheet/Excel/Writer/Format.php');
require_once(LIB_PATH.'pear/Spreadsheet/Excel/Writer/BIFFwriter.php');
require_once(LIB_PATH.'pear/Spreadsheet/Excel/Writer/Worksheet.php');
require_once(LIB_PATH.'pear/Spreadsheet/Excel/Writer/Parser.php');
require_once(LIB_PATH.'pear/OLE/PPS/Root.php');
require_once(LIB_PATH.'pear/OLE/PPS/File.php');
...
class Spreadsheet_Excel_Writer_Workbook extends Spreadsheet_Excel_Writer_BIFFwriter
{
    ...
    */
    ...
    {
        include_once(LIB_PATH.'pear/Spreadsheet/Excel/Writer/Validator.php');
