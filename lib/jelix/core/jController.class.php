...
abstract class jController{
    ...
    */
	...
	/**
	 * Decode de l'UTF8 vers l'ISO l'ensemble des paramètres de la requêtes
	 * Pratqiue pour les sites flash dynamique ou les appels sont encodés en UTF8
	 * @author : sylvain261 - 14/11/2007
	*/
	protected function request_utf8_decode(){
		foreach($this->request->params as $key => $value){
			$this->request->params[$key] = utf8_decode($value);
		}
	}
